...
VALUES (78780259,     1,    128) /* ItemType - Misc */
     ...
     , (78780259,     8,     25) /* Mass */
     , (78780259,    11,   10) /* MaxStackSize - 10 (1.25B): a stack's Value is unit x count in an int, and 18+ at 125M overflows it. The filled kit stays 1: each holds a different look */
