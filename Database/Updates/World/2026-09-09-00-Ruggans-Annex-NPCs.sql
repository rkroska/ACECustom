...
SET @e = LAST_INSERT_ID();
INSERT INTO `weenie_properties_emote_action` (`emote_Id`,`order`,`type`,`delay`,`extent`,`message`) VALUES
  (@e, 0, 10, 0, 0, 'Eleven things on the list. Most of them are smoke in a jar.'),
  ...
  (@e, 4, 10, 3.5, 0, 'The tinctures make a pet more or less see-through, a tenth at a time. They do nothing for actual ghosts.'),
  (@e, 5, 10, 3.5, 0, 'The tailoring kit takes the look off one pet and puts it on another. The first one does not survive that. The price reflects it.'),
  (@e, 6, 10, 3.5, 0, 'The neutering kit is for people who have made a decision. I don''t ask which decision.'),
  (@e, 7, 10, 3.5, 0, 'Buy off the list. I don''t haggle and I don''t explain the Professor.');
