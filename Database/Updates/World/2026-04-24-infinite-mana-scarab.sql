...
-- Using standard PropertyBool.UnlimitedUse (63) = 1

DELETE FROM `weenie_properties_bool` WHERE `weenie_class_Id` = 900002 AND `type` = 63;
INSERT INTO `weenie_properties_bool` (`weenie_class_Id`, `type`, `value`) VALUES (900002, 63, 1);
