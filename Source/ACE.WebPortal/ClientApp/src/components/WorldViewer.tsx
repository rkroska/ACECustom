...
const PRESET_CREATURES = [
  { wcid: 14513, name: 'Acid Elemental' },
  { wcid: 44021, name: 'Anekshay' },
  { wcid: 19, name: 'Armoredillo' },
  { wcid: 20017, name: 'Auroch' },
  { wcid: 6, name: 'Banderling' },
  { wcid: 26012, name: 'Burun' },
  { wcid: 11468, name: 'Carenzi' },
  { wcid: 4242, name: 'Chittick' },
  { wcid: 3110132, name: 'Cow' },
  { wcid: 4262, name: 'Deru' },
  { wcid: 7, name: 'Drudge' },
  { wcid: 99999989, name: 'Fae' },
  { wcid: 5705, name: 'Fire Elemental' },
  { wcid: 14512, name: 'Frost Elemental' },
  { wcid: 41224, name: 'Gear Knight' },
  { wcid: 28048, name: 'Ghost' },
  { wcid: 194, name: 'Golem' },
  { wcid: 7978, name: 'Grievver' },
  { wcid: 17, name: 'Gromnie' },
  { wcid: 43391, name: 'Gurog' },
  { wcid: 1536, name: 'Knathtead' },
  { wcid: 6379, name: 'Lightning Elemental' },
  { wcid: 5, name: 'Lugian' },
  { wcid: 2580, name: 'Mattekar' },
  { wcid: 32051, name: 'Merwart' },
  { wcid: 10, name: 'Mite' },
  { wcid: 4246, name: 'Moarsman' },
  { wcid: 2574, name: 'Monouga' },
  { wcid: 8, name: 'Mosswart' },
  { wcid: 31897, name: 'Mukkir' },
  { wcid: 7984, name: 'Niffis' },
  { wcid: 3, name: 'Olthoi' },
  { wcid: 12, name: 'Phyntos Wasp' },
  { wcid: 2566, name: 'Rabbit' },
  { wcid: 13, name: 'Rat' },
  { wcid: 18, name: 'Reedshark' },
  { wcid: 28666, name: 'Ruschk' },
  { wcid: 2583, name: 'Sclavus' },
  { wcid: 1756, name: 'Shadow' },
  { wcid: 2577, name: 'Shallows Shark' },
  { wcid: 4108, name: 'Shreth' },
  { wcid: 11486, name: 'Siraluun' },
  { wcid: 1759, name: 'Skeleton' },
  { wcid: 5760, name: 'Snowman' },
  { wcid: 28672, name: 'Thrungus' },
  { wcid: 226, name: 'Tumerok' },
  { wcid: 11, name: 'Tusker' },
  { wcid: 16, name: 'Undead' },
  { wcid: 7989, name: 'Ursuin' },
  { wcid: 420600, name: 'Viridian Statue' },
  { wcid: 23, name: 'Virindi' },
  { wcid: 1535, name: 'Wisp' },
  { wcid: 2608, name: 'Zefir' },
];
...
const WorldViewer: FC<WorldViewerProps> = ({ wcid: propWcid, paletteOverride: propPaletteOverride, hueShiftOverride: propHueShift, compactMode = false }) => {
  const [wcid, setWcid] = useState<number>(propWcid || 14513); // Default Acid Elemental (first species in list)
  const [searchInput, setSearchInput] = useState<string>((propWcid || 14513).toString());
