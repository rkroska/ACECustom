...
namespace ACE.Server.Command.Handlers
{
    public static class AdminStatCommands
    {
        ...
        public static void HandleQueueStatus(Session session, params string[] parameters)
        {
            ...
            var actionThrottle = PropertyManager.GetLong("action_queue_throttle_limit", 300).Item;
            ...
            var monsterThrottle = PropertyManager.GetLong("monster_tick_throttle_limit", 75).Item;
