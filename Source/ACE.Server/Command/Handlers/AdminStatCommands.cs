...
namespace ACE.Server.Command.Handlers
{
    public static class AdminStatCommands
    {
        ...
        public static void HandleServerStatus(Session session, params string[] parameters)
        {
            ...
            sb.Append($"{NetworkManager.GetSessionCount():N0} connections, {NetworkManager.GetAuthenticatedSessionCount():N0} authenticated connections, {NetworkManager.GetUnauthenticatedSessionCount():N0} unauthenticated connections, {NetworkManager.GetTerminatingSessionCount():N0} terminating, {NetworkManager.GetUniqueSessionEndpointCount():N0} unique connections, {PlayerManager.GetOnlineCount():N0} players online{'\n'}");
