    ...
    partial class Player
    {
        ...
        public bool TransferPyreals(long Amount, string CharacterDestination)
        {
            ...
            else
            {
                ...
                // Log the transfer
                TransferLogger.LogBankTransfer(this, CharacterDestination, "Pyreals", Amount, "Bank Transfer");
        ...
        public bool TransferLegendaryKeys(long Amount, string CharacterDestination)
        {
            ...
            else
            {
                ...
                // Log the transfer
                TransferLogger.LogBankTransfer(this, CharacterDestination, "Legendary Keys", Amount, "Bank Transfer");
        ...
        public bool TransferMythicalKeys(long Amount, string CharacterDestination)
        {
            ...
            else
            {
                ...
                // Log the transfer
                TransferLogger.LogBankTransfer(this, CharacterDestination, "Mythical Keys", Amount, "Bank Transfer");
        ...
        public bool TransferLuminance(long Amount, string CharacterDestination)
        {
            ...
            else
            {
                ...
                // Log the transfer
                TransferLogger.LogBankTransfer(this, CharacterDestination, "Luminance", Amount, "Bank Transfer");
        ...
        public bool TransferEnlightenedCoins(long Amount, string CharacterDestination)
        {
            ...
            else
            {
                ...
                // Log the transfer
                TransferLogger.LogBankTransfer(this, CharacterDestination, "Enlightened Coins", Amount, "Bank Transfer");
        ...
        public bool TransferWeaklyEnlightenedCoins(long Amount, string CharacterDestination)
        {
            ...
            else
            {
                ...
                // Log the transfer
                TransferLogger.LogBankTransfer(this, CharacterDestination, "Weakly Enlightened Coins", Amount, "Bank Transfer");
            }
                return true;
        }
