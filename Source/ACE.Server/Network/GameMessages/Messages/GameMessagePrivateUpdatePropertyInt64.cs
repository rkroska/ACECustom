...
{
    public class GameMessagePrivateUpdatePropertyInt64 : OutboundGameMessage
    {
        public GameMessagePrivateUpdatePropertyInt64(WorldObject worldObject, PropertyInt64 property, long value)
            : base(OutboundGameMessageOpcode.PrivateUpdatePropertyInt64, GameMessageGroup.UIQueue)
        {
