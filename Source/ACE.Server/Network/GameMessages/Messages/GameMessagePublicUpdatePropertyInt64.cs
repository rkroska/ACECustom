...
{
    public class GameMessagePublicUpdatePropertyInt64 : OutboundGameMessage
    {
        /// <summary>
        ///
        /// </summary>
        ...
        public GameMessagePublicUpdatePropertyInt64(WorldObject worldObject, PropertyInt64 property, long value)
            : base(OutboundGameMessageOpcode.PublicUpdatePropertyInt64, GameMessageGroup.UIQueue)
        {
