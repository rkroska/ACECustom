...
{
    public class GameMessagePublicUpdatePropertyFloat : OutboundGameMessage
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public GameMessagePublicUpdatePropertyFloat(WorldObject worldObject, PropertyFloat property, double value)
            : base(OutboundGameMessageOpcode.PublicUpdatePropertyFloat, GameMessageGroup.UIQueue)
        {
