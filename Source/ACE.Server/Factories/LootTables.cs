...
namespace ACE.Server.Factories
{
    public static class LootTables
    {
        ...
        {      //  0|250|300|325|350|370|400|420|430|500|525|550|575
                { 26, 33, 40, 47, 54, 61, 68, 71, 74, 90, 94, 98, 102 }, // Axe
                { 24, 31, 38, 45, 51, 58, 65, 68, 71, 87, 91, 95, 99 }, // Dagger
                { 13, 16, 20, 23, 26, 30, 33, 36, 38, 51, 54, 57, 59 }, // MultiDagger
                { 22, 29, 36, 43, 49, 56, 63, 66, 69, 85, 89, 93, 95 }, // Mace
                { 25, 32, 39, 46, 52, 59, 66, 69, 72, 88, 92, 96, 100 }, // Spear
                { 24, 31, 38, 45, 51, 58, 65, 68, 71, 87, 91, 95, 98 }, // Sword
                { 12, 16, 19, 23, 26, 30, 33, 36, 38, 52, 55, 58, 60 }, // MultiSword
                { 23, 30, 36, 43, 50, 56, 63, 66, 70, 75, 79, 83, 86 }, // Staff
                { 20, 26, 31, 37, 43, 48, 54, 56, 59, 75, 79, 81, 83 }  // UA
        };

        public static readonly int[,] LightWeaponDamageTable =
        {      //  0|250|300|325|350|370|400|420|430|500|525|550|575
                { 22, 28, 33, 39, 44, 50, 55, 58, 61, 77, 81, 85, 89 }, // Axe
                { 18, 24, 29, 35, 40, 46, 51, 54, 58, 74, 78, 82, 86 }, // Dagger
                {  7, 10, 13, 16, 18, 21, 24, 27, 28, 44, 48, 52, 56 }, // MultiDagger
                { 19, 24, 29, 35, 40, 45, 50, 53, 57, 72, 75, 79, 83}, // Mace
                { 21, 26, 32, 37, 43, 48, 53, 56, 60, 76, 80, 84, 88 }, // Spear
                { 20, 25, 31, 36, 41, 47, 52, 55, 58, 74, 78, 82, 86 }, // Sword
                {  7, 10, 13, 16, 18, 21, 24, 25, 28, 44, 48, 52, 56 }, // MultiSword
                { 19, 24, 30, 35, 40, 46, 51, 54, 57, 73, 77, 81, 85 }, // Staff
                { 17, 22, 26, 31, 35, 40, 44, 46, 48, 64, 68, 72, 76 }  // UA
        };

        public static readonly int[,] TwoHandedWeaponDamageTable =
        {      //  0|250|300|325|350|370|400|420|430|500|525|550|575
                { 13, 17, 22, 26, 30, 35, 39, 42, 45, 61, 65, 69, 73 }, // Cleaving
                { 14, 19, 23, 28, 33, 37, 42, 45, 48, 64, 68, 72, 76 }  // Spears
        };
        ...
        {
            new float[] { 2.1f, 2.1f, 2.2f, 2.3f, 2.4f, 2.4f, 2.4f, 2.4f, 2.4f, 2.75f, 2.75f, 2.75f }, // Bow
            new float[] { 2.4f, 2.4f, 2.5f, 2.55f, 2.65f, 2.65f, 2.65f, 2.65f, 2.65f, 3f, 3f, 3f }, // Crossbow
            new float[] { 2.3f, 2.3f, 2.4f, 2.5f, 2.6f, 2.6f, 2.6f, 2.6f, 2.6f, 2.95f, 2.95f, 2.95f }  // Thrown
        };
