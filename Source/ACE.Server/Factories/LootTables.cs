...
namespace ACE.Server.Factories
{
    public static class LootTables
    {
        ...
        {
            new int[] { 301, 3750, 3751, 3752, 3753, 64454600 },       //  0 - Battle Axe
            ...
            new int[] { 319, 3794, 3795, 3796, 3797, 64454602 },       //  6 - Jambiya (MS)
            new int[] { 30586, 30587, 30588, 30589, 30590 }, //  7 - Flanged Mace
            new int[] { 331, 3834, 3835, 3836, 3837, 64454601 },       //  8 - Mace
        ...
        public static readonly int[][] LightWeaponsMatrix =
        {
            ...
            new int[] { 314, 3778, 3779, 3780, 3781, 64454605 },       //  4 - Dagger (MS)
            ...
            new int[] { 348, 3873, 3874, 3875, 3876, 64454603 },       //  9 - Spear
            new int[] { 362, 3913, 3914, 3915, 3916 },       // 10 - Yari
            new int[] { 338, 22164, 22165, 22166, 22167, 64454604 },   // 11 - Quarter Staff
        ...
        public static readonly int[][] FinesseWeaponsMatrix =
        {
            ...
            new int[] { 30556, 30557, 30558, 30559, 30560, 64454606 }, //  1 - Hatchet
            ...
            new int[] { 321, 3802, 3803, 3804, 3805, 64454608 },       // 10 - Jitte
            ...
            new int[] { 6853, 45104, 45105, 45106, 45107, 64454607 },  // 15 - Rapier (MS)
        ...
        {
            new int[] { 40760, 40761, 40762, 40763, 40764, 64454610 }, //  0 - Nodachi
            ...
            new int[] { 41036, 41037, 41038, 41039, 41040, 64454609 }, //  8 - Assagai
        ...
        {      //  0|250|300|325|350|370|400|420|430|500|525|550|575|650|725|800
                { 26, 33, 40, 47, 54, 61, 68, 71, 74, 90, 94, 98, 102, 133, 145, 157 }, // Axe
                { 24, 31, 38, 45, 51, 58, 65, 68, 71, 87, 91, 95, 99, 129, 141, 153 }, // Dagger
                { 13, 16, 20, 23, 26, 30, 33, 36, 38, 51, 54, 57, 59, 68, 72, 76 }, // MultiDagger
                { 22, 29, 36, 43, 49, 56, 63, 66, 69, 85, 89, 93, 95, 124, 136, 148 }, // Mace
                { 25, 32, 39, 46, 52, 59, 66, 69, 72, 88, 92, 96, 100, 130, 142, 154 }, // Spear
                { 24, 31, 38, 45, 51, 58, 65, 68, 71, 87, 91, 95, 98, 128, 140, 152 }, // Sword
                { 12, 16, 19, 23, 26, 30, 33, 36, 38, 52, 55, 58, 60, 69, 73, 77 }, // MultiSword
                { 23, 30, 36, 43, 50, 56, 63, 66, 70, 75, 79, 83, 86, 112, 124, 136 }, // Staff
                { 20, 26, 31, 37, 43, 48, 54, 56, 59, 75, 79, 81, 83, 108, 120, 132 }  // UA
        };

        public static readonly int[,] LightWeaponDamageTable =
        {      //  0|250|300|325|350|370|400|420|430|500|525|550|575|650|725|800
                { 22, 28, 33, 39, 44, 50, 55, 58, 61, 77, 81, 85, 89, 116, 128, 140 }, // Axe
                { 18, 24, 29, 35, 40, 46, 51, 54, 58, 74, 78, 82, 86, 112, 124, 136 }, // Dagger
                {  7, 10, 13, 16, 18, 21, 24, 27, 28, 44, 48, 52, 56, 64, 68, 72 }, // MultiDagger
                { 19, 24, 29, 35, 40, 45, 50, 53, 57, 72, 75, 79, 83, 108, 120, 132}, // Mace
                { 21, 26, 32, 37, 43, 48, 53, 56, 60, 76, 80, 84, 88, 114, 126, 138 }, // Spear
                { 20, 25, 31, 36, 41, 47, 52, 55, 58, 74, 78, 82, 86, 112, 124, 136 }, // Sword
                {  7, 10, 13, 16, 18, 21, 24, 25, 28, 44, 48, 52, 56, 64, 68, 72 }, // MultiSword
                { 19, 24, 30, 35, 40, 46, 51, 54, 57, 73, 77, 81, 85, 111, 123, 135 }, // Staff
                { 17, 22, 26, 31, 35, 40, 44, 46, 48, 64, 68, 72, 76, 99, 111, 123 }  // UA
        };

        public static readonly int[,] TwoHandedWeaponDamageTable =
        {      //  0|250|300|325|350|370|400|420|430|500|525|550|575|650|725|800
                { 13, 17, 22, 26, 30, 35, 39, 42, 45, 61, 65, 69, 73, 95, 107, 119 }, // Cleaving
                { 14, 19, 23, 28, 33, 37, 42, 45, 48, 64, 68, 72, 76, 99, 111, 123 }  // Spears
        };
        ...
        {
            new float[] { 2.1f, 2.1f, 2.2f, 2.3f, 2.4f, 2.4f, 2.4f, 2.4f, 2.4f, 2.75f, 2.75f, 2.75f, 3.575f, 3.575f, 3.575f }, // Bow
            new float[] { 2.4f, 2.4f, 2.5f, 2.55f, 2.65f, 2.65f, 2.65f, 2.65f, 2.65f, 3f, 3f, 3f, 3.9f, 3.9f, 3.9f }, // Crossbow
            new float[] { 2.3f, 2.3f, 2.4f, 2.5f, 2.6f, 2.6f, 2.6f, 2.6f, 2.6f, 2.95f, 2.95f, 2.95f, 3.835f, 3.835f, 3.835f }  // Thrown
        };
        ...
        {
            new int[] { 29244, 29239, 29243, 29241, 29242, 29238, 29240, 64454611 },
            new int[] { 29251, 29246, 29250, 29248, 29249, 29245, 29247, 64454612 },
            new int[] { 29258, 29253, 29257, 29255, 29256, 29252, 29254, 64454613 },
