...
namespace ACE.Server.Factories
{
    public static partial class LootGenerationFactory
    {
        ...
        private static int GetNumMinorCantrips(TreasureDeath profile)
        {
            ...
            var dropRate = ServerConfig.minor_cantrip_drop_rate.Value;
            if (dropRate <= 0)
                return 0;
        ...
        private static int GetNumMajorCantrips(TreasureDeath profile)
        {
            ...
            var dropRate = ServerConfig.major_cantrip_drop_rate.Value;
            if (dropRate <= 0)
                return 0;
        ...
        private static int GetNumEpicCantrips(TreasureDeath profile)
        {
            ...
            var dropRate = ServerConfig.epic_cantrip_drop_rate.Value;
            if (dropRate <= 0)
                return 0;
        ...
        private static int GetNumLegendaryCantrips(TreasureDeath profile)
        {
            ...
            var dropRate = ServerConfig.legendary_cantrip_drop_rate.Value;
            if (dropRate <= 0)
                return 0;
