...
namespace ACE.Server.Factories.Tables
{
    public static class CantripChance
    {
        ...
        public static void ApplyNumCantripsMod(bool showResults = true)
        {
            ...
            var cantrip_drop_rate = (float)Math.Max(0.0f, ServerConfig.cantrip_drop_rate.Value);
        ...
        public static void ApplyCantripLevelsMod(bool showResults = true)
        {
            ...
            var minor_cantrip_drop_rate = (float)Math.Max(0.0f, ServerConfig.minor_cantrip_drop_rate.Value);
            var major_cantrip_drop_rate = (float)Math.Max(0.0f, ServerConfig.major_cantrip_drop_rate.Value);
            var epic_cantrip_drop_rate = (float)Math.Max(0.0f, ServerConfig.epic_cantrip_drop_rate.Value);
            var legendary_cantrip_drop_rate = (float)Math.Max(0.0f, ServerConfig.legendary_cantrip_drop_rate.Value);
