...
namespace ACE.Server.Managers
{
    ...
    public static class ServerConfig
    {
        ...
        /// <summary>If TRUE, prints verbose combat-pet follow/targeting/movement lines to the server process console. /modifybool pet_combat_debug_follow_ai_console.</summary>
        public static ConfigProperty<bool> pet_combat_debug_follow_ai_console { get; private set; } = new(false, "If TRUE, verbose combat pet idle follow + HandleFindTarget + Monster_Tick firstUpdate lines to stdout (server console).");
