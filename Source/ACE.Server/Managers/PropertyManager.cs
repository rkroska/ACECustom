...
namespace ACE.Server.Managers
{
    ...
    public static class ServerConfig
    {
        ...
        public static ConfigProperty<double> pet_combat_owner_recall_distance_m { get; private set; } = new(0.0, "Owner tether (m): pet farther than this from owner cannot acquire/fight and may drop target for follow (0 = use leash radius only). Set higher than leash radius so pets can fight mobs near a kiting owner.");
        public static ConfigProperty<double> pet_combat_leash_radius_m { get; private set; } = new(0.0, "Foe must be within this distance (m) of the pet, or within max(leash, owner tether) of the owner, to acquire. 0 = disabled.");
