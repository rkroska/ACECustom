...
namespace ACE.Server.Managers
{
    ...
    public static class ServerConfig
    {
        ...
        public static ConfigProperty<bool> room_assign_test_tools { get; private set; } = new(false, "Room Assign TEST tools (/zonecontrol dungeon fill, clear, admin, markers): fake players that make rooms count as taken, admins counting as players, landing markers. They change real hand-out decisions, so they are OFF unless this is true. Everything they do is in memory only. Change live: /modifybool room_assign_test_tools true");
        ...
        public static ConfigProperty<long> room_assign_startup_grace_minutes { get; private set; } = new(10, "Room Assign: holds live in memory and a restart wipes them, so for this many minutes after the world first opens a character logging in inside a free room keeps it (first to log in wins). 10 min (owner 2026-09-23). 0 = off, max 1440. Change live: /modifylong room_assign_startup_grace_minutes <minutes>");
