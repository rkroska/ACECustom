...
namespace ACE.Server.Managers
{
    ...
    public static class ServerConfig
    {
        ...
        // UCM Configuration
        public static ConfigProperty<string> ucmCheckFailTeleportLocation { get; private set; } = new("", "The location to send a player to when failing a UCM check. If blank, the player will be sent to the lifestone.");
        public static ConfigProperty<long> ucmCheckTimeoutSeconds { get; private set; } = new(60, "The amount of time a player has to respond to a UCM check before failing to timeout.");
