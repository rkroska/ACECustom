...
namespace ACE.Server.Entity
{
    public static class LandblockCollections
    {
        ...
        /// </summary>
        public static readonly Dictionary<ushort, string> ApartmentBlocks = new()
        {
        ...
        public static readonly HashSet<ushort> Tier10HuntingLandblocks = [];

        public static readonly HashSet<ushort> MarketplaceLandblocks = [0x016C];

        public static readonly HashSet<ushort> ApartmentLandblocks = [.. ApartmentBlocks.Keys];

        public static readonly HashSet<ushort> ConnectionExemptLandblocks = [.. MarketplaceLandblocks, ..ApartmentLandblocks];

        public static readonly HashSet<ushort> ThaelarynIslandLandblocks =
        [
            // North Tip
            ...
            0xF568, 0xF668, 0xF768, 0xF868, 0xF968,
            // Middle / Widening
        ...
        public static readonly HashSet<ushort> ValleyOfDeathLandblocks =
        [
            // Row 0x4A
        ...
        public static readonly HashSet<ushort> DarkIsleLandblocks =
        [
