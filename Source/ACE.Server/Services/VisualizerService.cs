...
namespace ACE.Server.Services
{
    ...
    public static class VisualizerService
    {
        ...
        public static List<SpeciesPresetDto> GetSpeciesList()
        {
            ...
            {
                new SpeciesPresetDto { Wcid = 3, Name = "Olthoi", Species = "Olthoi" },
                new SpeciesPresetDto { Wcid = 6, Name = "Banderling", Species = "Banderling" },
                new SpeciesPresetDto { Wcid = 7, Name = "Drudge", Species = "Drudge" },
                new SpeciesPresetDto { Wcid = 8, Name = "Mosswart", Species = "Mosswart" },
                new SpeciesPresetDto { Wcid = 5, Name = "Lugian", Species = "Lugian" },
                new SpeciesPresetDto { Wcid = 226, Name = "Tumerok", Species = "Tumerok" },
                new SpeciesPresetDto { Wcid = 10, Name = "Mite", Species = "Mite" },
                new SpeciesPresetDto { Wcid = 11, Name = "Tusker", Species = "Tusker" },
                new SpeciesPresetDto { Wcid = 12, Name = "Phyntos Wasp", Species = "Phyntos Wasp" },
                new SpeciesPresetDto { Wcid = 13, Name = "Rat", Species = "Rat" },
                new SpeciesPresetDto { Wcid = 20017, Name = "Auroch", Species = "Auroch" },
                new SpeciesPresetDto { Wcid = 3110132, Name = "Cow", Species = "Cow" },
                new SpeciesPresetDto { Wcid = 194, Name = "Golem", Species = "Golem" },
                new SpeciesPresetDto { Wcid = 16, Name = "Undead", Species = "Undead" },
                new SpeciesPresetDto { Wcid = 17, Name = "Gromnie", Species = "Gromnie" },
                new SpeciesPresetDto { Wcid = 18, Name = "Reedshark", Species = "Reedshark" },
                new SpeciesPresetDto { Wcid = 19, Name = "Armoredillo", Species = "Armoredillo" },
                new SpeciesPresetDto { Wcid = 99999989, Name = "Fae", Species = "Fae" },
                new SpeciesPresetDto { Wcid = 23, Name = "Virindi", Species = "Virindi" },
                new SpeciesPresetDto { Wcid = 1535, Name = "Wisp", Species = "Wisp" },
                new SpeciesPresetDto { Wcid = 1536, Name = "Knathtead", Species = "Knathtead" },
                new SpeciesPresetDto { Wcid = 1756, Name = "Shadow", Species = "Shadow" },
                new SpeciesPresetDto { Wcid = 2580, Name = "Mattekar", Species = "Mattekar" },
                new SpeciesPresetDto { Wcid = 2566, Name = "Rabbit", Species = "Rabbit" },
                new SpeciesPresetDto { Wcid = 2583, Name = "Sclavus", Species = "Sclavus" },
                new SpeciesPresetDto { Wcid = 2577, Name = "Shallows Shark", Species = "Shallows Shark" },
                ...
                new SpeciesPresetDto { Wcid = 14513, Name = "Acid Elemental", Species = "Acid Elemental" },
                ...
                new SpeciesPresetDto { Wcid = 7984, Name = "Niffis", Species = "Niffis" },
                ...
                new SpeciesPresetDto { Wcid = 28048, Name = "Ghost", Species = "Ghost" },
                new SpeciesPresetDto { Wcid = 28666, Name = "Ruschk", Species = "Ruschk" },
                new SpeciesPresetDto { Wcid = 28672, Name = "Thrungus", Species = "Thrungus" },
                new SpeciesPresetDto { Wcid = 31897, Name = "Mukkir", Species = "Mukkir" },
                new SpeciesPresetDto { Wcid = 32051, Name = "Merwart", Species = "Merwart" },
                new SpeciesPresetDto { Wcid = 41224, Name = "Gear Knight", Species = "Gear Knight" },
                new SpeciesPresetDto { Wcid = 43391, Name = "Gurog", Species = "Gurog" },
                new SpeciesPresetDto { Wcid = 44021, Name = "Anekshay", Species = "Anekshay" },
